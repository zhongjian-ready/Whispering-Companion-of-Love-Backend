...
type User struct {
	...
	CreatedAt    time.Time      `gorm:"type:datetime;default:CURRENT_TIMESTAMP;index:idx_users_created_at" json:"created_at"`
	...
	ReminderSettings  datatypes.JSON `gorm:"type:json" json:"reminder_settings,omitempty"`
	QuickAddSettings  datatypes.JSON `gorm:"type:json" json:"quick_add_settings,omitempty"`
	...
	QuickAddPresets   datatypes.JSON `gorm:"type:json" json:"quick_add_presets"`                        // [200, 300, 500, 800]
}
